...
public record Tutoria(
	...
	public Tutoria(DayOfWeek dia_de_la_semana, LocalTime hora_inicio,LocalTime hora_fin){
	
	//dia, hora inicio y duracion

	public Tutoria(DayOfWeek dia_de_la_semana, LocalTime hora_inicio, int duracion_min){
		this.dia_de_la_semana=dia_de_la_semana;
		this.hora_inicio=hora_inicio;
		this.hora_inicio=hora_inicio.plusMinutes(duracion_min);
	}
